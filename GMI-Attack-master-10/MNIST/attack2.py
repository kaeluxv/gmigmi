...
def inversion(G, D, T, E, iden, lr=0.2, momentum=0.9, lamda=100, iter_times=300, clip_range=1):
	...
	for random_seed in range(20):
		...
		z = torch.randn(bs, 10).cuda().float()
		z.requires_grad = True
		v = torch.zeros(bs, 10).cuda().float()
