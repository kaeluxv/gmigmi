...
train_dataloader = init_dataloader(args, train_file_path, 64)
test_dataloader = init_dataloader(args, test_file_path, 64)
...
optimizer = optim.SGD(model.parameter(), lr = lr, momentum = momentum, weight_decay, weight_decay)
