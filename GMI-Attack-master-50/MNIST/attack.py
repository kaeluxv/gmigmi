...
def inversion(G, D, T, E, iden, lr=1e-2, momentum=0.9, lamda=0.1, iter_times=1500, clip_range=1):
	...
	for random_seed in range(5):
		...
		for i in range(iter_times):
			...
			Prior_Loss = - lab`el.mean()
			Iden_Loss = criterion(out, iden)
			Total_Loss = Prior_Loss + lamda * Iden_Loss
	#		Total_Loss = Iden_Loss
			Total_Loss.backward()
...
if __name__ == "__main__":
	...
	g_path = "./Attack/attack_/MNIST_G.tar"
